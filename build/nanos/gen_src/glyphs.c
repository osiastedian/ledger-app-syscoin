#include "glyphs.h"
unsigned int const C_bitcoin_logo_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_bitcoin_logo_bitmap[] = {
...
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_bitcoin_logo = { GLYPH_bitcoin_logo_WIDTH, GLYPH_bitcoin_logo_HEIGHT, 1, C_bitcoin_logo_colors, C_bitcoin_logo_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
...
unsigned char const C_icon_validate_14_bitmap[] = {
  ...
  0x7e, 0x00, 0x0f, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00,
        ...
        #endif // HAVE_BAGL
#include "glyphs.h"
unsigned int const C_icon_wallet_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_icon_wallet_bitmap[] = {
  0xf8, 0x87, 0xff, 0x37, 0xc0, 0xf7, 0xef, 0x05, 0x70, 0xff, 0xdb, 0xff, 0xf6, 0xaf, 0xfd, 0x6f,
  0xff, 0x3b, 0x00, 0xff, 0xff, 0xfe, 0x1f, 0xfe, 0x01,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_icon_wallet = { GLYPH_icon_wallet_WIDTH, GLYPH_icon_wallet_HEIGHT, 1, C_icon_wallet_colors, C_icon_wallet_bitmap };
        #endif // HAVE_BAGL
#include "glyphs.h"
...
unsigned char const C_nanos_icon_dashboard_bitmap[] = {
  ...
  0x01, 0xe6, 0xc0, 0xf1, 0x3f, 0xf8, 0x07, 0x78, 0x00,
        ...
        #endif // HAVE_BAGL
#include "glyphs.h"
unsigned int const C_syscoin_logo_colors[] = {
  0x00000000,
  0x00010101,
  0x00ffffff,
  0x00ffffff,
...
unsigned char const C_syscoin_logo_bitmap[] = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0xa0, 0x2a, 0x00, 0x80, 0x00,
  0x00, 0x00, 0x08, 0xa8, 0x00, 0x80, 0x02, 0x2a, 0x00, 0xa8, 0x80, 0x02, 0x00, 0x2a, 0x20, 0x00,
  0x00, 0x00, 0x02, 0x00, 0xa8, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00,
};
#ifdef HAVE_BAGL
        #include "bagl.h"
        const bagl_icon_details_t C_syscoin_logo = { GLYPH_syscoin_logo_WIDTH, GLYPH_syscoin_logo_HEIGHT, 2, C_syscoin_logo_colors, C_syscoin_logo_bitmap };
        #endif // HAVE_BAGL
