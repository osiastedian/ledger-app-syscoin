    ...
    fn test_wallet_serialize_v2() {
        let wallet = WalletPolicy::new(
            ...
            vec![
               ...
               WalletPubKey::from_str("[7cac5506/48'/1'/0'/2']tpubDFAqEGNyad35aBCKUAXbQGDjdVhNueno5ZZVEn3sQbW5ci457gLR7HyTmHBg93oourBssgUxuWz1jX5uhc1qaqFo9VsybY1J5FuedLfm4dK").unwrap(),
            ],
        );
